...
$guncelle = $db->prepare("SELECT * FROM kullanicilar WHERE kullanici_adi=:name" );
$guncelle->execute(array(
  'name'=>$_SESSION['kullanici_adi']
));
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>MovArt | Sanat </span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li><a href="hakkimizda_ayar.php"><i class="fa fa-info"></i> Hakkımızda </a></li>
                ...
                <li><a href="menu.php"><i class="fa fa-forward"></i> Menüler</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    ...
                    <img src="images/img.jpg" alt=""> <?php echo $kullanicicek["kullanici_adi"]  ?>
            ...
            <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
              <li>
                <a>
                  ...
                  <span>
                    <span>Burak Tendon</span>
                    <span class="time">3 mins ago</span>
                  </span>
                  <span class="message">
                  Yaratıcı çalışmalarınızı takip etmeye devam edeceğim!
                  </span>
                </a>
              </li>
              <li>
                <a>
                  ...
                  <span class="message">
                  Sizinle ilgili heyecan verici bir haber paylaşmak istedim. Yaklaşan bir sanat sergisi için sizi davet etmek istiyoruz. Davet detayları aşağıda yer almaktadır:
                  .....
                  </span>
                </a>
              </li>
              <li>
                <a>
                  <span class="image"><img src="images/img.jpg" alt="Profile Image" /></span>
                  <span>
                    <span>Gül Çicek Solmaz</span>
                    <span class="time">3 mins ago</span>
                  </span>
                  <span class="message">
                  Sergiye katılımınızı bekliyoruz ve eserlerinizi sergilemek için büyük bir heyecan duyuyoruz!
                  </span>
                </a>
              </li>
              <li>
