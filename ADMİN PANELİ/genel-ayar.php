...
?>
  ...
  <form action="../netting/logoduzenle.php" method="POST" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left">
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
    ...
    <?php 
    if (strlen($genelayarlarigetir['logo'])>0)
     {?>
    <img width="200"  src="../../<?php echo $genelayarlarigetir['logo']; ?>">
    <?php 
    } 
    else 
    {?>
...
<input type="hidden" name="eski_yol" value="<?php echo $genelayarlarigetir['logo']; ?>">
...
<hr>
  ...
  -->
  <form action="../netting/islemgenel.php" method="POST"  id="demo-form2" data-parsley-validate 
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
  <input type="text" id="first-name" name="title" value="<?php echo $genelayarlarigetir['title']?>" required="required"
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
  <input type="text" id="first-name" name="description"value="<?php echo $genelayarlarigetir['description']?>"
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
  <input type="text" id="first-name" name="keywords" value="<?php echo $genelayarlarigetir['keywords']?>" 
  required="required" class="form-control col-md-7 col-xs-12">
  </div>
  </div>
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
  <input type="text" id="first-name" name="author" value="<?php echo $genelayarlarigetir['author']?>"
  required="required" class="form-control col-md-7 col-xs-12">
  </div>
  </div>
