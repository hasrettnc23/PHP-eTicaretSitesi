...
?>
          ...
          <div class="x_content">
            ...
            <form action="../netting/urunislemkategori.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              if (isset($_GET['urun_id'])) 
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="urun_sira" placeholder="Sıra giriniz" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
                <!-- Ck Editör Başlangıç -->
                <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                 <select id="urun-durum" class="form-control" name="urun_durum" required>
