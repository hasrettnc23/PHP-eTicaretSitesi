...
<!-- page content -->
    ...
    <div class="x_panel">
    <div class="x_title">
    <h2>Sosyal Ayarlar <small>İşlem Durumu</small></h2>
    ...
    <!--   
     ...
     -->
    <form action="../netting/islemsosyal.php" method="POST"  id="demo-form2" data-parsley-validate 
    ...
    <input type="text" id="first-name" name="facebook" value="<?php echo $sosyalayarlar['facebook']?>" 
    required="required"
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    <input type="text" id="first-name" name="twitter" value="<?php echo $sosyalayarlar['twitter']?>"
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    <input type="text" id="first-name" name="youtube" value="<?php echo $sosyalayarlar['youtube']?>" 
    required="required" class="form-control col-md-7 col-xs-12">
    </div>
    </div>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    <input type="text" id="first-name" name="google" value="<?php echo $sosyalayarlar['google']?>"
    required="required" class="form-control col-md-7 col-xs-12">
    </div>
    </div>
