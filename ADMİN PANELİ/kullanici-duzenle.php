...
?>
          ...
          <div class="x_content">
            ...
            <form action="../netting/islemduzenle.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
...
<?php
// Veritabanından datetime değerini al
...
?>
              ...
              <div class="form-group">
                ...
                <input type=" " id="kayit_tarihi" name="kullanici_zaman"  value="<?php echo $zaman[0]; ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="time" id="kayit_saati" name="kullanici_zaman" disabled="" value="<?php echo $zaman[1]; ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="email"  disabled="" value="<?php echo $kullanicicek['email'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
