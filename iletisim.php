	...
	<div class="row">
		<div class="col-md-4">
			...
			<ul class="contact-widget">
				<li class="fphone"><?php echo  $iletisimgetir['tel'] ?></li>
				<li class="fmobile"><?php echo  $iletisimgetir['gsm'] ?></li>
		...
		<div class="col-md-7 col-md-offset-1">
			...
			<div id="googlemaps" class="google-map google-map-footer">
				...
				src="https://www.google.com/maps/embed/v1/place?key=<?php echo $iletisimgetir['goooglemap']; ?>
				&q=<?php echo $iletisimgetir['adres']; ?>" allowfullscreen>
			</iframe>
