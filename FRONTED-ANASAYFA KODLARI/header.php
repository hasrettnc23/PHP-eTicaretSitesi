...
include 'nedmin/production/fonksiyon.php';
  ...
  $guncelle=$db->prepare("SELECT * FROM kullanicilar where kullanici_adi=:email");
  $guncelle->execute(array(
    'email' => isset($_SESSION['userkullanici_mail']) ? $_SESSION['userkullanici_mail'] : ""
    ));
  $say=$guncelle->rowCount();
...
<html lang="en">
  <head>
   ...
   <!-- <title> <?php // echo $genelayarlarigetir['title'] ?>  </title>   -->
	<meta name="description" content=<?php echo $genelayarlarigetir['description'] ?>>
    <meta name="keywords" content=<?php echo $genelayarlarigetir['keywords'] ?>>
    <meta name="author" content=<?php echo $genelayarlarigetir['author'] ?>>
  ...
  <div id="wrapper">
	...
	<a href="index.php"><img width="250" src="<?php echo $genelayarlarigetir['logo'] ?>" alt="Site logosu" class="logo img-responsive"></a>
	</div>
...
<div class="regwrap">
  <div class="row">
   ...
   <form action="nedmin/netting/islemkullanici.php" method="POST" role="form">

   <div class="form-group">
 <input type="text" class="form-control" name="kullanici_adi" id="username"  placeholder="Kullanıcı Adı">
                 </div>
                 <div class="form-group">
 <input type="password" class="form-control" name="parola" id="password"  placeholder="Şifre">
                 </div>
                 <div class="form-group">
             ...
             <div class="col-md-6">
               <div class="title-widget-bg">
               <form action="nedmin/production/register.php" method="POST" role="form">
                <div class="title-widget">Kayıt Ol</div>
              </div>
              <p>
                Yeni Kullanıcımısın? Alışverişe başlamak için hemen kayıt olmalısın!
              </p>
              <a href="register"><button type="submit" name="kullanicikaydet" class="btn btn-default btn-yellow">Kayıt Ol</button></a>
            </div>
          </div>
        </form>
